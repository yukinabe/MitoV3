...
// MARK: - Tutorial Engine (dialogue + spotlight coachmarks)

/// Collects on-screen frames of tutorial spotlight targets via the preference system,
/// so the coachmark can dim everything except the real control it points at.
